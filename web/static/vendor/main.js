...
var _user$project$Types$Formation = F2(
	function (a, b) {
		return {id: a, title: b};
	});
var _user$project$Types$Student = {ctor: 'Student'};
var _user$project$Types$Teacher = {ctor: 'Teacher'};
var _user$project$Types$Admin = {ctor: 'Admin'};
...
var _user$project$Msg$FormationMsg$ = function (a) {
	return {ctor: 'FormationMsg\'', _0: a};
};
var _user$project$Msg$UserMsg$ = function (a) {
...
var _user$project$Msg$FetchUsers = {ctor: 'FetchUsers'};
var _user$project$Msg$GotFormations = function (a) {
	return {ctor: 'GotFormations', _0: a};
};
var _user$project$Msg$FetchFormations = {ctor: 'FetchFormations'};

var _user$project$Decoders$formationDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	_user$project$Types$Formation,
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$int)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string));
var _user$project$Decoders$formationsDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['data']),
	_elm_lang$core$Json_Decode$list(_user$project$Decoders$formationDecoder));
...
var _user$project$API$fetchFormations = F2(
	function (errorMsg, msg) {
		return A3(
			_elm_lang$core$Task$perform,
			errorMsg,
			msg,
			A2(_evancz$elm_http$Http$get, _user$project$Decoders$formationsDecoder, '/api/formations'));
	});
var _user$project$API$fetchUsers = F2(
	function (errorMsg, msg) {
		return A3(
			_elm_lang$core$Task$perform,
			errorMsg,
			msg,
			A2(_evancz$elm_http$Http$get, _user$project$Decoders$usersDecoder, '/api/users'));
	});

var _user$project$Model$initialModel = {mdl: _debois$elm_mdl$Material$model, tab: 0, users: _elm_lang$core$Maybe$Nothing, formations: _elm_lang$core$Maybe$Nothing};
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {mdl: a, tab: b, users: c, formations: d};
	});

var _user$project$Update$updateFormationMsg = F2(
	function (msg, model) {
		var _p0 = A2(_elm_lang$core$Debug$log, 'updateFormationMsg', msg);
		if (_p0.ctor === 'FetchFormations') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						function (_p1) {
							return _user$project$Msg$FormationMsg$(
								_user$project$Msg$GotFormations(_p1));
						})
					]));
		} else {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						formations: _elm_lang$core$Maybe$Just(_p0._0)
					}),
				_elm_lang$core$Native_List.fromArray(
					[]));
		}
	});
var _user$project$Update$updateUserMsg = F2(
	function (msg, model) {
		var _p2 = A2(_elm_lang$core$Debug$log, 'updateUserMsg', msg);
		if (_p2.ctor === 'FetchUsers') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_user$project$API$fetchUsers,
						_elm_lang$core$Basics$always(_user$project$Msg$NoOp),
						function (_p3) {
							return _user$project$Msg$UserMsg$(
								_user$project$Msg$GotUsers(_p3));
						})
					]));
		} else {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						users: _elm_lang$core$Maybe$Just(_p2._0)
					}),
				_elm_lang$core$Native_List.fromArray(
					[]));
		}
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'UserMsg\'':
				return A2(_user$project$Update$updateUserMsg, _p4._0, model);
			case 'FormationMsg\'':
				return A2(_user$project$Update$updateFormationMsg, _p4._0, model);
			case 'SelectTab':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
